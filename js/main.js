...
const Notifications = {
    ...
    initialNotifications: [
        ...
        { id: '7', type: 'event', user: 'Emanuel', avatar: 'images/Emanuel.jpg', message: 'Lembrete: Sua aula de <strong>"Programação do Zero ao Avançado"</strong> começa em 30 minutos.', isNew: true, actionBtn: { text: 'Ver Detalhes', class: 'btn-secondary', action: 'view-details' } },
